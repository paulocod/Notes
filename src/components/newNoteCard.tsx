...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className="rounded-md bg-slate-700 p-5 flex flex-col gap-3 overflow-hidden text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:right-2 focus-visible:ring-lime-400">
                <span
